...
def update_cart_item(cart_id):
    ...
    try:
        ...
        if cart_item is None:
            return create_success_response({\'message\': \'Item removed from cart\'}) # Fixed: Removed extra parenthesis
...
def clear_cart():
    ...
    try:
        ...
        return create_success_response({\'message\': \'Cart cleared\'}) # Fixed: Removed extra parenthesis
...
def cancel_order(order_id):
    ...
    try:
        ...
        return create_success_response({\'message\': \'Order cancelled successfully\'}) # Fixed: Removed extra parenthesis
